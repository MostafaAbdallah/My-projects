...
/*
	* means LATER
	...
	Design Problems:
		...
		- should we keep track of selected control points or not ???????!!!!!!!!!!!!!!!!!!!!!!!!
*/
...
public:
	...
	void drawVectorAddition(float t);
	...
	glm::vec3& getControlPoint(const unsigned int& index);
...
private:
	...
	std::vector<std::vector<glm::vec3>> constructionPoints;
};
