...
public class BracketsSysParser extends Parser {
	...
	public static final int
		...
		T__9=10, T__10=11, ID=12, EXPR=13, FLOAT=14, INT=15, WS=16;
	public static final int
	...
	@Override
	public String getGrammarFileName() { return "BracketsSys.g4"; }
	...
	public BracketsSysParser(TokenStream input) {
		super(input);
	...
	public static class ProgContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BracketsSysListener ) ((BracketsSysListener)listener).enterProg(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BracketsSysListener ) ((BracketsSysListener)listener).exitProg(this);
		}
	}
	...
	public static class AxiomContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BracketsSysListener ) ((BracketsSysListener)listener).enterAxiom(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BracketsSysListener ) ((BracketsSysListener)listener).exitAxiom(this);
		}
	}
	...
	public static class LstrContext extends ParserRuleContext {
		public TerminalNode ID() { return getToken(BracketsSysParser.ID, 0); }
		public List<LstrContext> lstr() {
			return getRuleContexts(LstrContext.class);
		}
		public LstrContext lstr(int i) {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BracketsSysListener ) ((BracketsSysListener)listener).enterLstr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BracketsSysListener ) ((BracketsSysListener)listener).exitLstr(this);
		}
	}
	...
	public static class ProductionContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BracketsSysListener ) ((BracketsSysListener)listener).enterProduction(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BracketsSysListener ) ((BracketsSysListener)listener).exitProduction(this);
		}
	}
	...
	public static class AngleContext extends ParserRuleContext {
		public TerminalNode FLOAT() { return getToken(BracketsSysParser.FLOAT, 0); }
		public TerminalNode INT() { return getToken(BracketsSysParser.INT, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BracketsSysListener ) ((BracketsSysListener)listener).enterAngle(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BracketsSysListener ) ((BracketsSysListener)listener).exitAngle(this);
		}
	}
	...
	public static class LineLenghtContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BracketsSysListener ) ((BracketsSysListener)listener).enterLineLenght(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BracketsSysListener ) ((BracketsSysListener)listener).exitLineLenght(this);
		}
	}
	...
	public static class IterationContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BracketsSysListener ) ((BracketsSysListener)listener).enterIteration(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BracketsSysListener ) ((BracketsSysListener)listener).exitIteration(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\b\n\f\16\2\3\3\2\20\21A\2\20\3\2\2\2\4\32\3\2\2\2\6+\3\2\2\2\b-\3\2\2"+
		...
		"\2?@\7\21\2\2@\17\3\2\2\2\7\24\36\'+\63";
